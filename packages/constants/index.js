...
// 添加一个动画
export const ACTION_ANIMATES_ADD = 'ACTION_ANIMATES_ADD';
// 删除一个动画
export const ACTION_ANIMATES_REMOVE = 'ACTION_ANIMATES_REMOVE';
// 修改一个动画
export const ACTION_ANIMATES_CHANGE = 'ACTION_ANIMATES_CHANGE';
// 预览整个动画
export const ACTION_ANIMATES_PREVIEW = 'ACTION_ANIMATES_PREVIEW';
// 预览一个动画
export const ACTION_ANIMATES_PREVIEW_ONE = 'ACTION_ANIMATES_PREVIEW_ONE';
// 鼠标移动到动画上预览
export const ACTION_ANIMATES_HOVER = 'ACTION_ANIMATES_HOVER';
// 置空动画预览
export const ACTION_ANIMATES_EMPTY = 'ACTION_ANIMATES_EMPTY';
// 多个激活态元素对齐方式-左对齐
export const ACTION_MULTI_ALIGN_LEFT = 'ACTION_MULTI_ALIGN_LEFT';
// 多个激活态元素对齐方式-右对齐
export const ACTION_MULTI_ALIGN_RIGHT = 'ACTION_MULTI_ALIGN_RIGHT';
// 多个激活态元素对齐方式-上对齐
export const ACTION_MULTI_ALIGN_TOP = 'ACTION_MULTI_ALIGN_TOP';
// 多个激活态元素对齐方式-下对齐
export const ACTION_MULTI_ALIGN_BOTTOM = 'ACTION_MULTI_ALIGN_BOTTOM';
// 多个激活态元素对齐方式-下对齐
export const ACTION_MULTI_ALIGN_CENTER = 'ACTION_MULTI_ALIGN_CENTER';
// 多个激活态元素对齐方式-下对齐
export const ACTION_MULTI_ALIGN_CENTER_VERTICAL = 'ACTION_MULTI_ALIGN_CENTER_VERTICAL';
// 多个激活态元素对齐方式-下对齐
export const ACTION_MULTI_ALIGN_CENTER_HORIZONTAL = 'ACTION_MULTI_ALIGN_CENTER_HORIZONTAL';
// 修改多个激活态元素对齐方式
...
// 艺术字 - 阴影
export const COMPONENT_TYPE_ART_SHADOW = 'COMPONENT_TYPE_ART_SHADOW';
// 艺术字 - 立体
export const COMPONENT_TYPE_ART_SOLID = 'COMPONENT_TYPE_ART_SOLID';
// 艺术字 - 描边
export const COMPONENT_TYPE_ART_BORDER = 'COMPONENT_TYPE_ART_BORDER';
// 链接
export const COMPONENT_TYPE_LINK = 'COMPONENT_TYPE_LINK';
// 母亲节
export const COMPONENT_TYPE_MOTHER_DAY = 'COMPONENT_TYPE_MOTHER_DAY';
// 永远爱你
export const COMPONENT_TYPE_LOVE_FOREVER = 'COMPONENT_TYPE_LOVE_FOREVER';
...
// 可展开面板
export const STYLE_RENDER_TYPE_COLLAPSE = 'STYLE_RENDER_TYPE_COLLAPSE';
// 一行两个输入框
export const STYLE_RENDER_TYPE_TWO_INPUT = 'STYLE_RENDER_TYPE_TWO_INPUT';
// 图片库
export const STYLE_RENDER_TYPE_PICTURE = 'STYLE_RENDER_TYPE_PICTURE';
// 字体库
export const STYLE_RENDER_TYPE_FONT = 'STYLE_RENDER_TYPE_FONT';
...
/** 预览动画的类型 */
// 预览整个动画
export const TYPE_PREVIEW_ANIMATE_ALL = 'TYPE_PREVIEW_ANIMATE_ALL';
// 预览其中一个动画
export const TYPE_PREVIEW_ANIMATE_CURRENT = 'TYPE_PREVIEW_ANIMATE_CURRENT';
// 预览鼠标悬浮某个动画
export const TYPE_PREVIEW_ANIMATE_HOVER = 'TYPE_PREVIEW_ANIMATE_HOVER';
